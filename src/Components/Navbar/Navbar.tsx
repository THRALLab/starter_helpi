...
export function Navbar2({ page, setPage }: { page: string; setPage: (newPage: string) => void }) {
  ...
  return (
    <Navbar sticky="top" style={{color: 'white', backgroundColor: '#0e1014', height: '4rem', marginTop: '.25rem', marginRight: '.25rem', marginLeft: '.25rem' }} data-bs-theme="dark" expand="lg">
      <Container>
